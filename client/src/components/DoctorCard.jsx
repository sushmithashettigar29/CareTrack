...
import { FaUserMd, FaEnvelope, FaPhone, FaCalendarAlt, FaStar, FaClinicMedical } from "react-icons/fa";
import { MdVerified, MdPending, MdCancel } from "react-icons/md";

export function DoctorCard({ doctor, userRole, onApprove, onReject, onDelete }) {
  return (
          ...
          <div className="flex-1">
            ...
            <div className="mt-1 flex items-center gap-2">
              <span className="inline-flex items-center gap-1 bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">
                ...
                <span className="capitalize">{doctor.specialization || "General"}</span>
              </span>
